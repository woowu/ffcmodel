...
function FfcModel()
{
    ...
    const markTime = (devid, ticktime, cb) => {
        ...
        client.zadd(['fm:m:tm:' + devid, blockindex, blockindex], err => {
            if (err) return cb(err);
            client.zadd(['fm:tm', blockindex, blockindex], cb);
        });
    };

    const markArchivedTime = (devid, blockindex, cb) => {
        client.zadd(['fm:a:m:tm:' + devid, blockindex, blockindex], err => {
            if (err) return cb(err);
            client.zadd(['fm:a:tm', blockindex, blockindex], cb);
        });
    };
    ...
    const removeBlockIndex = (blockindex, cb) => {
        const walkDevices = (list, removedDevices, cb) => {
            ...
            client.zrem(['fm:m:tm:' + devid, blockindex], (err, reply) => {
                if (err) return cb(err);
        ...
        client.zrem(['fm:tm', blockindex], err => {
    ...
    const removeBlocksAfter = (blockindex, cb) => {
        ...
        client.zrangebyscore(['fm:tm', '(' + blockindex, '+inf'], (err, reply) => {
